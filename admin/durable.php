<?php
$page_name = 'รายการครุภัณฑ์';
$page_active = 'durable';
$page_current = 'durable';
  ...
  <div class="row">
    <div class="x_content">
      ...
      <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0"><i class="fa fa-list-alt"></i> รายการครุภัณฑ์</h4>
...
<script type="text/javascript">
  $(document).ready(function() {
    $('#dataTable').DataTable({
      ...
      "autoWidth": false,
      'ajax': {
        'url': 'services/durable_data.php', // ไฟล์นี้ต้องมีอยู่จริง
        'type': 'post',
        data: {
